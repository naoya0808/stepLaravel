...
<?php endif; ?>
        ...
        <form method="post" action="<?php echo e(route('post.store')); ?>"><?php echo csrf_field(); ?>
            <div class="mt-8">
...
<?php endif; ?>
                    <input type="text" name="title" class="w-auto py-2border border-gray-300 rounded-md" id="title" value="<?php echo e(old('title')); ?>">
                </div>
...
<?php unset($__componentOriginalf94ed9c5393ef72725d159fe01139746); ?>
<?php endif; ?>
                    <textarea name="body" class="w-auto py-2 border border-gray-300 rounded-md" id="body" cols="30" rows="5"><?php echo e(old('body')); ?></textarea>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-4']); ?>送信する <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/post/create.blade.php ENDPATH**/ ?>