...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <form method="post" action="<?php echo e(route('post.update', $post)); ?>"><?php echo csrf_field(); ?>
...
<?php endif; ?>
                    <input type="text" name="title" class="w-auto py-2border border-gray-300 rounded-md" id="title" value="<?php echo e(old('title', $post->title)); ?>">
                </div>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/post/edit.blade.php ENDPATH**/ ?>